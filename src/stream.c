...
static void stream_env_get_runtime (void) {
...
static unsigned int stream_env_get_port (void) {
...
static void stream_env_get_cerver_receive_buffer_size (void) {
...
static void stream_env_get_cerver_th_threads (void) {
...
static void stream_env_get_cerver_connection_queue (void) {
...
static unsigned int stream_env_get_mongo_app_name (void) {
...
static unsigned int stream_env_get_mongo_db (void) {
...
static unsigned int stream_env_get_mongo_uri (void) {
...
static unsigned int stream_init_env (void) {

	unsigned int errors = 0;

	stream_env_get_runtime ();

	errors |= stream_env_get_port ();

	stream_env_get_cerver_receive_buffer_size ();

	stream_env_get_cerver_th_threads ();
